! function(t) {
	...
	i.prototype = {
		...
		renIns: function() {
			for(var t = this.ele.find(".carousel-item").length - 2, i = '<div class="carousel-indicators">', n = 0; n < t; n++) i += '<span class="span" data-index="' + n + '"></span>';
		...
		eventBind: function() {
			...
			btns.each(function(index) {
				$(this).mouseover("click", function() {
					i.animate((t($(".span")[index]).data("index") - i.index) * -o)
				});
			});
